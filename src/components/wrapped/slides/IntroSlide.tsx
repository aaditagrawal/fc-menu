  ...
  return (
    <Slide className="relative">
      <div className="text-center space-y-6 animate-scale-in">
        ...
        <div className="text-4xl sm:text-6xl font-bold tracking-tight">Wrapped</div>
        <div className="text-2xl sm:text-3xl font-mono accent-yellow">{year}</div>
        <p
          className="text-muted-foreground text-base sm:text-lg max-w-md mx-auto mt-8 animate-fade-in delay-300"
          style={{ opacity: 0, animationFillMode: "forwards" }}
        >
          A look back at what Food Court 2 served this semester
        </p>
        <p
          className="text-xs text-muted-foreground/70 max-w-sm mx-auto animate-fade-in delay-500"
          style={{ opacity: 0, animationFillMode: "forwards" }}
        >
