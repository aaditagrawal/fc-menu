    ...
    <Slide pattern="dots">
      <div className="text-center space-y-12 max-w-xl mx-auto w-full px-4">
        ...
        <div className="space-y-4">
          <h2
            className="text-3xl sm:text-4xl font-bold animate-slide-up delay-100"
        ...
        <div
          className="animate-slide-up delay-300 py-8"
          style={{ opacity: 0, animationFillMode: "forwards" }}
        >
          <p className="text-lg sm:text-2xl font-medium leading-relaxed max-w-md mx-auto">
            Around <span className="accent-rose font-bold">4,000</span> people eat at
            <br />
        ...
        <div
          className="pt-8 space-y-3 animate-fade-in delay-500 max-w-xs mx-auto"
          style={{ opacity: 0, animationFillMode: "forwards" }}
        >
          <Link
            href="/"
