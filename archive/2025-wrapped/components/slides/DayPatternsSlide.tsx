  ...
  return (
    <Slide>
      <div className="text-center space-y-8 max-w-2xl mx-auto">
        <h2 className="text-2xl sm:text-3xl font-bold animate-slide-up">Day Signatures</h2>

        <p
          className="text-muted-foreground animate-slide-up delay-100"
            ...
            >
              ...
              <div className="space-y-1 w-full">
                {pattern.signature.length > 0 ? (
                  ...
                  <div className="text-sm text-muted-foreground italic">Mostly staples</div>
                )}
              </div>
            </div>
          ))}
        ...
        <p
          className="text-xs text-muted-foreground mt-4 animate-fade-in delay-800"
          style={{ opacity: 0, animationFillMode: "forwards" }}
        >
