  ...
  return (
    <Slide pattern="dots">
      <div className="text-center space-y-8">
        <p className="text-lg text-muted-foreground animate-slide-up">We tracked</p>

        <StatNumber value={STATIC_TOTAL_MEALS} className="accent-rose" />

        <p
          className="text-2xl sm:text-3xl font-medium animate-slide-up delay-200"
        ...
        <p
          className="text-muted-foreground animate-slide-up delay-300"
          style={{ opacity: 0, animationFillMode: "forwards" }}
        >
        ...
        <p
          className="text-sm text-muted-foreground italic mt-4 animate-fade-in delay-800"
          style={{ opacity: 0, animationFillMode: "forwards" }}
        >
