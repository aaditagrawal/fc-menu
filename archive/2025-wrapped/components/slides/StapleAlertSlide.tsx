  ...
  return (
    <Slide pattern="dots">
      <div className="text-center space-y-8 max-w-xl mx-auto">
        ...
        <h2
          className="text-2xl sm:text-3xl font-bold animate-slide-up delay-100"
        ...
        <p
          className="text-muted-foreground animate-slide-up delay-200"
          style={{ opacity: 0, animationFillMode: "forwards" }}
        >
        ...
        <div
          className="stat-card border-2 border-rose py-8 animate-scale-in delay-300"
          style={{ opacity: 0, animationFillMode: "forwards" }}
        >
          <p className="text-2xl sm:text-3xl font-bold accent-rose mb-4">{mostRepeated.name}</p>
        ...
        <p
          className="text-sm text-muted-foreground mt-4 animate-fade-in delay-600"
          style={{ opacity: 0, animationFillMode: "forwards" }}
        >
